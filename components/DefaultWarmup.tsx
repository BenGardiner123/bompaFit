...
// The default warm-up, in Tools. One list the lifter keeps once and points any
...
// A failed load draws nothing rather than throwing the whole Tools screen away.
const Editor = lazy(() =>
